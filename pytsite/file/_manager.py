...
from pytsite.core.validation._validator import Validator
from pytsite.core.validation._rule import Url
...
def create(source_path: str, name: str=None, description: str=None, model='file', remove_source=False) -> File:
    ...
    url_validator.add_rule('url', Url(value=source_path))
...
def get_by_ref(ref: DBRef) -> File:
    ...
    entity = odm.manager.get_by_ref(ref)
    if not entity:
        return
