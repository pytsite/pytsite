...
class Form(_settings.Form):
    def _setup_widgets(self):
        self.add_widget(_widget.input.Text(
            uid='setting_app_id',
            weight=10,
            label=_lang.t('pytsite.vk@app_id'),
            required=True,
            help=_lang.t('pytsite.vk@app_id_setup_help'),
        ...
        self.add_widget(_widget.input.Text(
            ...
            weight=20,
            label=_lang.t('pytsite.vk@app_secret'),
            required=True,
            help=_lang.t('pytsite.vk@app_secret_setup_help'),
