...
from pytsite.core import router, form
from pytsite import admin

__settings = {}


def define_setting(uid: str, form: form.Base, menu_title: str, menu_icon: str, menu_weight: int=0):
    ...
    url = router.endpoint_url('pytsite.settings.eps.form', {'uid': uid})
