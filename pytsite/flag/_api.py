...
def count(entity: _odm.Entity) -> int:
    """Get overall flags count for this entity.
    """
    return _odm.find('flag').where('entity', '=', entity).count()


def is_flagged(entity: _odm.Entity, author: _auth.model.User) -> bool:
...
def flag(entity: _odm.Entity, author: _auth.model.User):
    if author.is_anonymous:
        return
...
def unflag(entity: _odm.Entity, author: _auth.model.User):
    if author.is_anonymous:
        return
...
def toggle(entity: _odm.Entity, author: _auth.model.User) -> bool:
