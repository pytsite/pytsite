...
class TestApi:
    def test_register_model(self):
        ...
        odm.register_model('fixture', 'test_api.FixtureModel', True)
        with pytest.raises(NameError):
    ...
    def test_get_registered_models(self):
        ...
        assert len(odm.get_registered_models()) == 0

        odm.register_model('fixture', FixtureModel)
        assert len(odm.get_registered_models()) == 1

        assert odm.get_registered_models()[0] == 'fixture'
